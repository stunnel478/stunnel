...
cd /usr/bin
wget -O add-ss "https://linkkalian/add-ss.sh"
wget -O del-ss "https://linkkalian/del-ss.sh"
wget -O cek-ss "https://linkkalian/cek-ss.sh"
wget -O renew-ss "https://linkkalian/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
