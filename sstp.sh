...
#input perintah sstp
wget -O /usr/bin/add-sstp https://linkkalian/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://linkkalian/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/cek-sstp https://linkkalian/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -O /usr/bin/renew-sstp https://linkkalian/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
