...
# Tambahan
cd /usr/bin
wget -O add-wg "https://linkkalian/add-wg.sh"
wget -O del-wg "https://linkkalian/del-wg.sh"
wget -O cek-wg "https://linkkalian/cek-wg.sh"
wget -O renew-wg "https://linkkalian/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
