...
wget https://raw.githubusercontent.com/stunnel478/stunnel/main/cf.sh && chmod +x cf.sh && ./cf.sh
#install ssh ovpn
...
#install v2ray
wget hhttps://raw.githubusercontent.com/stunnel478/stunnel/main/ins-vt.sh && chmod +x ins-vt.sh && screen -S v2ray ./ins-vt.sh
#install L2TP
